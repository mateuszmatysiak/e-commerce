...
export const AccountMenu = () => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <Menu.Button className="relative w-10 h-10 rounded-full overflow-hidden border border-slate-800">
        <Image
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-200 text-black bg-white rounded-md shadow-lg">
          ...
          <Menu.Item>
            <button className="flex items-center gap-2 py-3 px-4 w-full" onClick={() => signOut()}>
